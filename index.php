...
<main> 
<?php
// نجيب المنتجات اللي كميتها أكبر من صفر فقط
...
<div class="product">
    ...
    <div class="product_section"><a href="section.php?section=<?php echo $row['prosection'];?>"><?php echo $row['prosection']; ?></a></div><br>
    <div class="product_name"><a href=""><?php echo $row['proname']; ?></a></div>
    <div class="product_price"><a href=""><?php echo $row['proprice']; ?> SR </a></div>
    <div class="product_description"><a href="detalis.php?id=<?php echo $row['id']?>"><i class="fa-solid fa-eye"></i>&nbsp;لتفاصيــل المنتــج إضغط هنا</a></div>
    ...
    <div class="qty_input">
        <form action="cart.php" method="POST" onsubmit="return validateQty(this, <?php echo $row['quantity']; ?>)">  
            ...
            <input type="number" id="" name="quantity" value="1" min="1" max="<?php echo $row['quantity']; ?>" data-stock="<?php echo $row['quantity']; ?>">
